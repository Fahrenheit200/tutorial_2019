...
(cl:defmethod cl:initialize-instance :after ((m <def_message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'def_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name publisher-msg:<def_message> is deprecated: use publisher-msg:def_message instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <def_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader publisher-msg:x-val is deprecated.  Use publisher-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <def_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader publisher-msg:y-val is deprecated.  Use publisher-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <def_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader publisher-msg:z-val is deprecated.  Use publisher-msg:z instead.")
  (z m))
